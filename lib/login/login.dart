                      ...
                      child:
                        Column(
                          children:[
                            ...
                            Text('Smart Feeder',  style: new TextStyle(fontFamily: 'TitanOne', fontSize: 40)),
                          ]
                        ),
                    ),
                              ...
                              Row(
                                ...
                                children: [
                                  TextButton(
                                    ...
                                    child: Text('¿Olvidó su contraseña?', style: TextStyle(color: Colors.blue, fontSize: 15),),
                                  ),
                                  TextButton(
                                    onPressed: () => register(context),
                                    child: Text('Registrarse!', style: TextStyle(color: Colors.blue, fontSize: 15), ),
                                  ),
                                ],
                              ),
                              Padding(
